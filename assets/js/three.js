let scene,camera,renderer,controls,sat_model,point_light;
...
for(let i =0; i< 50; i++){
    ...
    function changeSatelliteModel(src){
...
function animate(){
    ...
    if(window.sat_cords != undefined){
        ...
        marker.quaternion.setFromEuler(
            new THREE.Euler(window.sat_cords.lat * rad,0, window.sat_cords.lng * rad,"XYZ"));
